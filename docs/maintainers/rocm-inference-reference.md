...
| <https://github.com/ROCm/torch_migraphx/> | upstream GitHub repo | 2026-04-22 | `planned` | `docs/backlog.md`; `docs/maintainers/rocm-inference-reference.md` | `python-torch-migraphx-gfx1151` build/import smoke | Existing `migraphx-gfx1151` remains the MIGraphX anchor. |
...
- Add `python-torch-migraphx-gfx1151` as a package candidate. First acceptance
  gates: build, import, a tiny FX/Dynamo lowering smoke, and the ResNet50 PT2E
  quantization flow if its dependencies are available.

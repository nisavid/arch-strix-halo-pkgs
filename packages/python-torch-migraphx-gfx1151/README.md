...
- Post-deploy on 2026-06-15, Torch-MIGraphX import and the PT2E quantizer-import scenario fail below this package because installed migraphx-gfx1151 7.13.0-2 links libmigraphx_onnx.so against libprotobuf.so.34.1.0 while the host has protobuf 35. Repair or rebuild the TheRock/MIGraphX protobuf ABI surface before rerunning Torch-MIGraphX validation.

...
DIST_INFO = (
    REPO_ROOT
    / "packages/python-mistral-common-gfx1151/pkg/python-mistral-common-gfx1151/usr/lib/python3.14/site-packages/mistral_common-1.10.0.dist-info/METADATA"
)
REQUEST_MODULE = (
    REPO_ROOT
...
def test_built_package_exports_reasoning_effort():
    ...
    assert "Version: 1.10.0" in DIST_INFO.read_text()
